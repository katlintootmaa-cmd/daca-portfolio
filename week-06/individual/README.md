...
- kui tugev on Tallinna kogutulu;
- kuidas muutub Tallinna müük kuude lõikes;
- millised tooted või kategooriad toovad kõige rohkem müüki;
...
Paigutasin kõige olulisemad KPI kaardid dashboard'i ülemisse ossa, sest juht peab nägema üldpilti kohe esimesena. Müügitrendi jaoks kasutasin joondiagrammi, sest see sobib kõige paremini ajas muutumise näitamiseks. Toodete või kategooriate võrdluseks kasutasin tulpdiagrammi, sest see võimaldab kiiresti märgata, mis müüki kõige rohkem veab.

Annotatsioonide eesmärk oli tuua välja mitte ainult suur number, vaid ka selle tähendus. Näiteks kui mõni kuu või kategooria paistab eriti tugevalt välja, peab dashboard selgitama, miks see juhtkonna jaoks oluline on.
